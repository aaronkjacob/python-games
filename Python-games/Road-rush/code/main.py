...
class Obstacle(pygame.sprite.Sprite):
  def __init__(self):
    ...
    if image == 2:
      self.image = pygame.image.load('Python-games/Road-rush/assets/red-pickup-truck.png').convert_alpha()
    if image == 3:
      self.image = pygame.image.load('Python-games/Road-rush/assets/red-semi-truck.png').convert_alpha()
    if image == 4:
      self.image = pygame.image.load('Python-games/Road-rush/assets/yellow-car.png').convert_alpha()
    if image == 5:
      self.image = pygame.image.load('Python-games/Road-rush/assets/yellow-pickup-truck.png').convert_alpha()
    if image == 6:
      self.image = pygame.image.load('Python-games/Road-rush/assets/yellow-semi-truck.png').convert_alpha()
